...
import { ArrowLeftCircleIcon, CheckCircle, Lock, Play } from 'lucide-react';
...
export default function KelasModule() {
    ...
    return (
        <AffiliateLayoutTemplate>
            <Head title="Module Kelas" />
            <main className="mx-auto flex w-full max-w-9xl flex-1 flex-col gap-6 p-4 md:p-6 lg:p-8">
                <div>
                    <Link href={kelas.show.course(module_data.course_id)}>
                ...
                <Separator />
                <div className="mx-auto flex w-full max-w-9xl flex-1 flex-col gap-6 lg:flex-row">
                    <div className="flex flex-1 flex-col gap-6">
                        <div className="group relative overflow-hidden rounded-2xl bg-black shadow-2xl">
                            <div className="video-aspect relative flex w-full items-center justify-center bg-slate-900">
                        ...
                        <div className="flex flex-col justify-between gap-4 border-b border-surface-dark pb-6 md:flex-row md:items-center">
                            ...
                            <button className="flex items-center justify-center gap-2 rounded-xl bg-tiktok-cyan px-8 py-3 font-black text-black transition-all hover:bg-cyan-400 active:scale-95">
                                LANJUT MATERI
                        ...
                        <Tabs defaultValue="description" className="w-full">
                            ...
                            <TabsContent value="description">
                                <CardDescription className="mt-4 mb-6 leading-relaxed text-text-muted">
                                    <div
                                ...
                                <div className="space-x-1">
                                    <ul className="mb-8 grid grid-cols-1 gap-3 text-sm text-text-muted md:grid-cols-2 lg:grid-cols-3">
                                        {primaryVideo.metadata.tags.map(
                                            (tag) => (
                                                <li
                                                    key={tag}
                                                    className="flex items-start gap-2"
                                                >
                                                    <span className="material-symbols-outlined mt-1 text-sm text-tiktok-cyan">
                                                        check_circle
                                                    </span>
                                                    {tag}
                                                </li>
    ...
    return (
        <aside className="flex w-full flex-col gap-4 lg:w-96">
            <div className="flex h-fit flex-col overflow-hidden rounded-2xl border border-gray-800 bg-surface-dark">
                ...
                <div className="no-scrollbar h-105 overflow-y-auto">
                    {videos?.length > 0 &&
